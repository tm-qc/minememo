...
module.exports = {
  ...
  siteMetadata: {
    ...
    //profile本文
    profile:`
    いつでも転職希望の 業務経験6年目(2022時点)
    仕事の合間にすこしずつ転職活動はしていますが、条件合う場合ぜひTwitterなどでご連絡頂けると嬉しいです。

希望条件は現在の年収を下回らない(手取り31万以上)、基本残業なし、ある程度保守運用が管理されていて、その経験ができる職場で働きたいです。 
（管理がされてない案件が多く、心的安全が少ない仕事が多いので、ある程度安心して働きたいと感じています。）
