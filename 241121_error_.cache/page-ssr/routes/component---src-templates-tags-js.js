...
/* harmony import */ var _pages_side_tag_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../pages/side_tag_list */ "./src/pages/side_tag_list.js");
/* harmony import */ var _pages_twitter_timeline__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pages/twitter_timeline */ "./src/pages/twitter_timeline.js");
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! gatsby */ "./.cache/gatsby-browser-entry.js");
/* harmony import */ var _components_css_index_module_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/css/index.module.css */ "./src/components/css/index.module.css");
...
const Tags = ({
  ...
  const tagHeader = `「${tag} 」Tag 記事一覧(${totalCount} post${totalCount === 1 ? "" : "s"})`;
  // const tagHeader = `${totalCount} post${
  //   totalCount === 1 ? "" : "s"
  // } tagged with "${tag}"`

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: _components_css_index_module_css__WEBPACK_IMPORTED_MODULE_6__.tagHeader
  }, "\uD83C\uDFF7\uFE0F", tagHeader), edges.map(({
    node
  }) => {
    const {
      slug
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: _components_css_index_module_css__WEBPACK_IMPORTED_MODULE_6__.articleFrame,
      key: slug
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_5__.Link, {
      className: _components_css_index_module_css__WEBPACK_IMPORTED_MODULE_6__.articleBox,
      to: slug
    }, listImgSrc(node), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: _components_css_index_module_css__WEBPACK_IMPORTED_MODULE_6__.articleData
    }, title, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, date)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: _components_css_index_module_css__WEBPACK_IMPORTED_MODULE_6__.articlePrev,
      dangerouslySetInnerHTML: {
        __html: htmlClean(node.html)
      }
    })));
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: _components_css_index_module_css__WEBPACK_IMPORTED_MODULE_6__.sideFrame
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_pages_profile__WEBPACK_IMPORTED_MODULE_2__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_pages_side_tag_list__WEBPACK_IMPORTED_MODULE_3__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_pages_twitter_timeline__WEBPACK_IMPORTED_MODULE_4__["default"], null)));
};
Tags.propTypes = {
  ...
  data: prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
    allMarkdownRemark: prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
      totalCount: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number.isRequired),
      edges: prop_types__WEBPACK_IMPORTED_MODULE_7___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
        node: prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
          frontmatter: prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
            title: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().string.isRequired)
          }),
          fields: prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
